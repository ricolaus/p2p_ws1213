...
n2otmp = Queue.Queue()
o2ntmp = Queue.Queue()
watcherQtmp = Queue.Queue()

user1Folder = "User1/"
overlay2 = Overlay("User1", "localhost", 50001, "localhost", 50000, n2otmp, o2ntmp, a2otmp, o2atmp, watcherQtmp)
...
network2 = Network(user1Folder, "localhost", 50001, 60010, 10, n2otmp, o2ntmp, watcherQtmp, 2)
network2.run()
