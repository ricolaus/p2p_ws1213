REM start python watcher.py
sleep 3
mkdir User0
start python client.py "User0" "User0/" "localhost" 50000 "localhost" 50002 60000 10
sleep 3
mkdir User1
...
sleep 3
mkdir User6
start python client.py "User6" "User6/" "localhost" 50006 "localhost" 50005 60060 10
sleep 3
mkdir User7
start python client.py "User7" "User7/" "localhost" 50007 "localhost" 50006 60070 10
sleep 3
mkdir User8
start python client.py "User8" "User8/" "localhost" 50008 "localhost" 50007 60080 10